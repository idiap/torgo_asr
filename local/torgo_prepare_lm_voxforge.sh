...
echo ""
echo "=== Building a language model with Torgo+Voxforge train..."
...
# Create TVFtext, a new file with Torgo+Voxforge train
cat data/train/text $KALDI_ROOT/egs/voxforge/s5/data/train/text > data/train/TVFtext
